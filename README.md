...
- **マヤ暦ツォルキン**: ユリウス通日にGMT相関定数 584283 を用い、260日周期に落とします。数え方は伝統的なツォルキンで、Long Count 13.0.0.0.0（2012-12-21）が 4 Ahau（自己存在の黄色い太陽）になるよう整合させています。2月29日を飛ばすドリームスペルの数え方ではありません（キンの名称の訳語だけはドリームスペル系のものを使っています）。
