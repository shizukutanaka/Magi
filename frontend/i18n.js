export const CATALOGS = {
  ja: {
    ...
    "result.traditions_may_disagree": "流派ごとに答えが食い違うことがあります。一致しない点は、どちらかが正しいのではなく、判断を保留して考え直す材料として使いましょう。",
    ...
    "status.share_incomplete": "この共有リンクには再現用のトークンが含まれていないため、共有された鑑定ではなくこのブラウザの鑑定を表示しています。",
  ...
  en: {
    ...
    "result.traditions_may_disagree": "Different traditions can disagree. Where they do not line up, treat it not as one being right, but as a cue to hold off and think again.",
    ...
    "status.share_incomplete": "This link carries no reproducibility token, so this is a new reading for this browser — not the shared one.",
